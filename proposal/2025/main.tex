...
\begin{abstract}
%
The SILM Workshop on Security of Software/Hardware Interfaces (originally
in French: \enquote{S\'ecurit\'e des Interfaces Logiciel/Mat\'eriel})
solicits submissions -- full papers and work-in-progress submissions --
around attacks and defences that specifically involve the interaction of
hardware and software, such as vulnerabilities in hardware platforms,
software attacks that use such vulnerabilities, or defence mechanisms that
involve the co-design of hardware and software. We have already organised
five iterations of the SILM workshop, mostly co-located with EuroS\&P.
...
with a focus on fostering interaction and collaborations, and sharing
...
inclusive environment and adapt the scope of SILM to include new
challenges and approached to developing secure systems.

This is a proposal for a \emph{full-day} EuroS\&P \SILMYear{}
